...
export default function RegisterPage() {
  ...
  return (
    <>
      <title>Register | Viamsh FMCG</title>
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-lg">
            ...
            <div className="text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Join Viamsh FMCG and start shopping
              </p>
            </div>

            {/* Google Register */}
            <button className="mt-6 flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 px-4 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50">
            ...
            <p className="mt-6 text-center text-sm text-gray-500">
              ...
              <Link href="/account/login" className="font-medium text-brand-green hover:underline">
                Login
              </Link>
            </p>
          </div>
